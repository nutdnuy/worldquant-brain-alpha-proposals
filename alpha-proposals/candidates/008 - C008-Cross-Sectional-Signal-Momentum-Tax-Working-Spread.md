---
title: "C008 - Cross Sectional Signal Momentum - Tax Working Spread"
...
# C008 - Cross Sectional Signal Momentum - Tax Working Spread
...
| Common operators | `ts_backfill, vec_avg, group_rank, ts_decay_linear` |
...
| Operator overlap | Common operators are `ts_backfill, vec_avg, group_rank, ts_decay_linear`. |
