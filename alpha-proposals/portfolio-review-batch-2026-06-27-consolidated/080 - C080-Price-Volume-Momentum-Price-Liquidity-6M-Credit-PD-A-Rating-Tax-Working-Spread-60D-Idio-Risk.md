---
title: "C080 - Price Volume Momentum - Price Liquidity + 6M Credit PD + A- Rating + Tax Working Spread + 60D Idio Risk"
...
# C080 - Price Volume Momentum - Price Liquidity + 6M Credit PD + A- Rating + Tax Working Spread + 60D Idio Risk
...
| Dominant families | risk/credit/volatility (2), tax/accounting fundamentals (2) |
| Common fields | `alpha1_ret, returns, alpha1_scaled, unsystematic_risk_last_60_days, annualized_pd_6_month_jc7, alpha2, alpha1, alpha2_scaled, fnd6_txws, alpha3, alpha3_scaled, probability_dist_a_minus` |
| Common operators | `ts_delta, max, group_rank, ts_corr, rank, ts_zscore, vec_avg, ts_mean, ts_decay_linear, ts_std_dev, scale, ts_backfill` |
...
| Field overlap | Common fields are `alpha1_ret, returns, alpha1_scaled, unsystematic_risk_last_60_days, annualized_pd_6_month_jc7, alpha2, alpha1, alpha2_scaled, fnd6_txws, alpha3, alpha3_scaled, probability_dist_a_minus`. |
| Operator overlap | Common operators are `ts_delta, max, group_rank, ts_corr, rank, ts_zscore, vec_avg, ts_mean, ts_decay_linear, ts_std_dev, scale, ts_backfill`. |
| Family overlap | Dominant workbook families are risk/credit/volatility (2), tax/accounting fundamentals (2). |
