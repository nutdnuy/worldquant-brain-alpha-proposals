---
title: "C015 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew + Receivables Change + A- Rating + 7Y Credit PD"
...
# C015 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew + Receivables Change + A- Rating + 7Y Credit PD
...
| Dominant families | risk/credit/volatility (6), price-volume/liquidity/turnover (6), analyst/model scores (6), options/implied volatility (6), tax/accounting fundamentals (6) |
| Common fields | `alpha4, annualized_pd_7_year_jc7, implied_volatility_put_270, anl4_netdebt_number, alpha2, pcr_oi_270, implied_volatility_call_270, alpha1, probability_non_investment_grade_rating, alpha3, anl4_detailrecv4_est, probability_dist_a_minus` |
| Common operators | `min, ts_rank, group_zscore, ts_corr, rank, vec_avg, ts_mean, trade_when, scale, ts_backfill, group_neutralize` |
...
| Field overlap | Common fields are `alpha4, annualized_pd_7_year_jc7, implied_volatility_put_270, anl4_netdebt_number, alpha2, pcr_oi_270, implied_volatility_call_270, alpha1, probability_non_investment_grade_rating, alpha3, anl4_detailrecv4_est, probability_dist_a_minus`. |
| Operator overlap | Common operators are `min, ts_rank, group_zscore, ts_corr, rank, vec_avg, ts_mean, trade_when, scale, ts_backfill, group_neutralize`. |
| Family overlap | Dominant workbook families are risk/credit/volatility (6), price-volume/liquidity/turnover (6), analyst/model scores (6), options/implied volatility (6), tax/accounting fundamentals (6). |
