---
title: "C064 - EPS Revision Shock - EPS Estimate + Capital Cost Base + Operating Profit"
...
# C064 - EPS Revision Shock - EPS Estimate + Capital Cost Base + Operating Profit
...
| Dominant families | tax/accounting fundamentals (2), price-volume/liquidity/turnover (2), earnings/EPS/guidance revisions (2), analyst/model scores (1) |
| Common fields | `cogs_leg, cap, cogs, c, op, ey, est_epsr, ern4_fcsterneffct, fe, cost, fnd6_fopo, close` |
| Common operators | `ts_rank, winsorize, zscore, group_rank, ts_backfill, rank, abs, vec_avg, trade_when, scale, ts_mean, group_neutralize` |
...
| Field overlap | Common fields are `cogs_leg, cap, cogs, c, op, ey, est_epsr, ern4_fcsterneffct, fe, cost, fnd6_fopo, close`. |
| Operator overlap | Common operators are `ts_rank, winsorize, zscore, group_rank, ts_backfill, rank, abs, vec_avg, trade_when, scale, ts_mean, group_neutralize`. |
| Family overlap | Dominant workbook families are tax/accounting fundamentals (2), price-volume/liquidity/turnover (2), earnings/EPS/guidance revisions (2), analyst/model scores (1). |
