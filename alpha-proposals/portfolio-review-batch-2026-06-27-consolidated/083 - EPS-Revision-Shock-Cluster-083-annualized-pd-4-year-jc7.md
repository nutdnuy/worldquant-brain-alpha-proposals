---
title: "EPS Revision Shock Cluster 083 - annualized_pd_4_year_jc7"
...
# EPS Revision Shock Cluster 083 - annualized_pd_4_year_jc7
...
| Common fields | `annualized_pd_4_year_jc7, alpha1, mdl177_2_earningmomentumfactor400_fy1epsskew, alpha1_raw, mdl77_2gdna_sighc, useStd, alpha3_raw, mdl77_ohistoricalgrowthfactor_fcfequity, mdl77_valueanalystmodelqva_epmodule, alpha2_raw, probability_dist_a_plus, normalize` |
| Common operators | `signed_power, zscore, scale, winsorize, ts_std_dev, ts_mean, max, group_neutralize, ts_backfill, ts_corr, rank` |
...
| Field overlap | Common fields are `annualized_pd_4_year_jc7, alpha1, mdl177_2_earningmomentumfactor400_fy1epsskew, alpha1_raw, mdl77_2gdna_sighc, useStd, alpha3_raw, mdl77_ohistoricalgrowthfactor_fcfequity, mdl77_valueanalystmodelqva_epmodule, alpha2_raw, probability_dist_a_plus, normalize`. |
| Operator overlap | Common operators are `signed_power, zscore, scale, winsorize, ts_std_dev, ts_mean, max, group_neutralize, ts_backfill, ts_corr, rank`. |
