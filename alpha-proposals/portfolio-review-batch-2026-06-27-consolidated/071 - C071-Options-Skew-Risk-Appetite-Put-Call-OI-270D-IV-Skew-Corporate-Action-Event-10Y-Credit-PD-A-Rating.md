---
title: "C071 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew + Corporate Action Event + 10Y Credit PD + A Rating"
...
# C071 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew + Corporate Action Event + 10Y Credit PD + A Rating
...
| Dominant families | risk/credit/volatility (2), price-volume/liquidity/turnover (2), options/implied volatility (2) |
| Common fields | `alpha4, returns, fnd6_newqeventv110_dpactq, implied_volatility_put_270, annualized_pd_10_year_jc7, alpha2, pcr_oi_270, implied_volatility_call_270, alpha1, probability_dist_a, probability_non_investment_grade_rating, alpha3` |
...
| Field overlap | Common fields are `alpha4, returns, fnd6_newqeventv110_dpactq, implied_volatility_put_270, annualized_pd_10_year_jc7, alpha2, pcr_oi_270, implied_volatility_call_270, alpha1, probability_dist_a, probability_non_investment_grade_rating, alpha3`. |
...
| Family overlap | Dominant workbook families are risk/credit/volatility (2), price-volume/liquidity/turnover (2), options/implied volatility (2). |
