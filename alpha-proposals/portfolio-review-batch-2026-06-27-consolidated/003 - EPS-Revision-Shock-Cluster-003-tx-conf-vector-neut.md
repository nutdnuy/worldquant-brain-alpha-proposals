---
title: "EPS Revision Shock Cluster 003 - tx_conf vector_neut"
...
# EPS Revision Shock Cluster 003 - tx_conf vector_neut
...
| Dominant families | quality/growth/value (20), price-volume/liquidity/turnover (20), tax/accounting fundamentals (20), analyst/model scores (20), risk/credit/volatility (20), earnings/EPS/guidance revisions (20), options/implied volatility (2) |
| Common fields | `tx_conf, vector_neut, mdl177_garpanalystmodel_qgp_vfpriceratio, returns, fnd6_txws, min_free_cash_flow_per_share_guidance, garp_alpha, volatility, garp_signal, tx_alpha, tx_dir, tx_q` |
| Common operators | `if_else, ts_std_dev, scale, ts_mean, vec_avg, abs, ts_decay_linear, group_rank, group_neutralize, ts_backfill, rank, ts_arg_max` |
...
| Field overlap | Common fields are `tx_conf, vector_neut, mdl177_garpanalystmodel_qgp_vfpriceratio, returns, fnd6_txws, min_free_cash_flow_per_share_guidance, garp_alpha, volatility, garp_signal, tx_alpha, tx_dir, tx_q`. |
| Operator overlap | Common operators are `if_else, ts_std_dev, scale, ts_mean, vec_avg, abs, ts_decay_linear, group_rank, group_neutralize, ts_backfill, rank, ts_arg_max`. |
| Family overlap | Dominant workbook families are quality/growth/value (20), price-volume/liquidity/turnover (20), tax/accounting fundamentals (20), analyst/model scores (20), risk/credit/volatility (20), earnings/EPS/guidance revisions (20), options/implied volatility (2). |
