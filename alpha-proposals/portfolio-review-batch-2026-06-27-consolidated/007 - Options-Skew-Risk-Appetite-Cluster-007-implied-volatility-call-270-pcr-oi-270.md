---
title: "Options Skew Risk Appetite Cluster 007 - implied_volatility_call_270 pcr_oi_270"
...
# Options Skew Risk Appetite Cluster 007 - implied_volatility_call_270 pcr_oi_270
...
| Dominant families | options/implied volatility (12), risk/credit/volatility (12) |
| Common fields | `implied_volatility_call_270, pcr_oi_270, implied_volatility_put_270` |
...
| Field overlap | Common fields are `implied_volatility_call_270, pcr_oi_270, implied_volatility_put_270`. |
| Operator overlap | Common operators are `ts_mean, group_zscore, trade_when`. |
| Family overlap | Dominant workbook families are options/implied volatility (12), risk/credit/volatility (12). |
