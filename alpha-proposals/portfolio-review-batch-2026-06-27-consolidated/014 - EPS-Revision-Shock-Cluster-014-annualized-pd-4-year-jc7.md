---
title: "EPS Revision Shock Cluster 014 - annualized_pd_4_year_jc7"
...
# EPS Revision Shock Cluster 014 - annualized_pd_4_year_jc7
...
| Dominant families | quality/growth/value (6), options/implied volatility (6), tax/accounting fundamentals (6), risk/credit/volatility (6), earnings/EPS/guidance revisions (6) |
| Common fields | `annualized_pd_4_year_jc7, alpha1, eps_previous_estimate_value, alpha4, alpha3, pcr_oi_270, implied_volatility_call_270, fnd6_txws, research_development_expense, implied_volatility_put_270, alpha2, probability_dist_a_plus` |
| Common operators | `scale, ts_mean, vec_avg, group_zscore, group_rank, ts_decay_linear, group_neutralize, ts_backfill, ts_corr, rank, trade_when` |
...
| Field overlap | Common fields are `annualized_pd_4_year_jc7, alpha1, eps_previous_estimate_value, alpha4, alpha3, pcr_oi_270, implied_volatility_call_270, fnd6_txws, research_development_expense, implied_volatility_put_270, alpha2, probability_dist_a_plus`. |
| Operator overlap | Common operators are `scale, ts_mean, vec_avg, group_zscore, group_rank, ts_decay_linear, group_neutralize, ts_backfill, ts_corr, rank, trade_when`. |
| Family overlap | Dominant workbook families are quality/growth/value (6), options/implied volatility (6), tax/accounting fundamentals (6), risk/credit/volatility (6), earnings/EPS/guidance revisions (6). |
