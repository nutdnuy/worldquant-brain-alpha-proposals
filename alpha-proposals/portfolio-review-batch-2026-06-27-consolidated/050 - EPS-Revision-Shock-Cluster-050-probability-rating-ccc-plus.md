---
title: "EPS Revision Shock Cluster 050 - probability_rating_ccc_plus"
...
# EPS Revision Shock Cluster 050 - probability_rating_ccc_plus
...
| Dominant families | options/implied volatility (3), earnings/EPS/guidance revisions (3), risk/credit/volatility (3), price-volume/liquidity/turnover (3) |
| Common fields | `alpha1, probability_rating_ccc_plus, pcr_oi_270, alpha3, implied_volatility_call_270, alpha4, returns, annualized_pd_2_year_jc7, implied_volatility_put_270, earnings_per_share_reported, alpha2, probability_non_investment_grade_rating` |
| Common operators | `ts_rank, zscore, scale, ts_mean, vec_avg, group_zscore, min, group_rank, group_neutralize, ts_backfill, trade_when, ts_arg_max` |
...
| Field overlap | Common fields are `alpha1, probability_rating_ccc_plus, pcr_oi_270, alpha3, implied_volatility_call_270, alpha4, returns, annualized_pd_2_year_jc7, implied_volatility_put_270, earnings_per_share_reported, alpha2, probability_non_investment_grade_rating`. |
| Operator overlap | Common operators are `ts_rank, zscore, scale, ts_mean, vec_avg, group_zscore, min, group_rank, group_neutralize, ts_backfill, trade_when, ts_arg_max`. |
| Family overlap | Dominant workbook families are options/implied volatility (3), earnings/EPS/guidance revisions (3), risk/credit/volatility (3), price-volume/liquidity/turnover (3). |
