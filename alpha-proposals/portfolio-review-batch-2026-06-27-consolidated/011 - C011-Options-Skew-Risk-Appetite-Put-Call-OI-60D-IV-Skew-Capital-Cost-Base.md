---
title: "C011 - Options Skew Risk Appetite - Put-Call OI + 60D IV Skew + Capital Cost Base"
...
# C011 - Options Skew Risk Appetite - Put-Call OI + 60D IV Skew + Capital Cost Base
...
| Dominant families | tax/accounting fundamentals (2), risk/credit/volatility (2), options/implied volatility (2) |
| Common fields | `raw2, implied_volatility_call_60, pcr_oi_270, cap, raw2_g, raw1, cogs, a1, raw2_c, raw2_c0, implied_volatility_put_60, a2` |
| Common operators | `trade_when, zscore, group_zscore, abs, ts_mean, scale, rank, group_neutralize` |
...
| Field overlap | Common fields are `raw2, implied_volatility_call_60, pcr_oi_270, cap, raw2_g, raw1, cogs, a1, raw2_c, raw2_c0, implied_volatility_put_60, a2`. |
| Operator overlap | Common operators are `trade_when, zscore, group_zscore, abs, ts_mean, scale, rank, group_neutralize`. |
| Family overlap | Dominant workbook families are tax/accounting fundamentals (2), risk/credit/volatility (2), options/implied volatility (2). |
