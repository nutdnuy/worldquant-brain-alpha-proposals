---
title: "C077 - Price Volume Momentum - Price Liquidity + News Signal + AA+ Rating + Credit Curve"
...
# C077 - Price Volume Momentum - Price Liquidity + News Signal + AA+ Rating + Credit Curve
...
| Dominant families | risk/credit/volatility (2), analyst/model scores (2), news/sentiment/buzz (2), price-volume/liquidity/turnover (2) |
| Common fields | `alpha3, returns, alpha1_scaled, alpha2, alpha2_avg_news, alpha1, alpha2_scaled, mdl53_ms5_6month, nws12_afterhsz_sl, probability_dist_aa_plus, vwap, close` |
...
| Field overlap | Common fields are `alpha3, returns, alpha1_scaled, alpha2, alpha2_avg_news, alpha1, alpha2_scaled, mdl53_ms5_6month, nws12_afterhsz_sl, probability_dist_aa_plus, vwap, close`. |
...
| Family overlap | Dominant workbook families are risk/credit/volatility (2), analyst/model scores (2), news/sentiment/buzz (2), price-volume/liquidity/turnover (2). |
