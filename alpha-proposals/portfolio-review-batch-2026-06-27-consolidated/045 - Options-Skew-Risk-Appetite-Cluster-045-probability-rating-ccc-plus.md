---
title: "Options Skew Risk Appetite Cluster 045 - probability_rating_ccc_plus"
...
# Options Skew Risk Appetite Cluster 045 - probability_rating_ccc_plus
...
| Dominant families | options/implied volatility (3), analyst/model scores (3), risk/credit/volatility (3), price-volume/liquidity/turnover (3) |
| Common fields | `alpha1, probability_rating_ccc_plus, pcr_oi_270, alpha3, implied_volatility_call_270, alpha4, anl4_dez1basicafv4_est, fnd6_newqeventv110_lqpl1q, annualized_pd_2_year_jc7, implied_volatility_put_270, alpha2, probability_non_investment_grade_rating` |
| Common operators | `ts_rank, zscore, scale, ts_mean, vec_avg, group_zscore, min, group_neutralize, ts_backfill, ts_corr, rank, trade_when` |
...
| Field overlap | Common fields are `alpha1, probability_rating_ccc_plus, pcr_oi_270, alpha3, implied_volatility_call_270, alpha4, anl4_dez1basicafv4_est, fnd6_newqeventv110_lqpl1q, annualized_pd_2_year_jc7, implied_volatility_put_270, alpha2, probability_non_investment_grade_rating`. |
| Operator overlap | Common operators are `ts_rank, zscore, scale, ts_mean, vec_avg, group_zscore, min, group_neutralize, ts_backfill, ts_corr, rank, trade_when`. |
| Family overlap | Dominant workbook families are options/implied volatility (3), analyst/model scores (3), risk/credit/volatility (3), price-volume/liquidity/turnover (3). |
