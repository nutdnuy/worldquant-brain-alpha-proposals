---
title: "EPS Revision Shock Cluster 093 - alpha1_raw"
type: alpha-cluster-proposal
project: worldquant-brain
proposal_batch: portfolio-review-2026-06-27-consolidated
cluster_id: cluster-093
member_count: 2
...
# EPS Revision Shock Cluster 093 - alpha1_raw
...
| Common fields | `alpha1, alpha1_raw, mdl177_valuemomemtummodel_earningsqualitymodule, annualized_pd_3_year_jc7, useStd, alpha3_raw, mdl177_2_globaldevnorthamerica_v502_aspanratio, mdl77_2growthanalystmodel_qga_opmarginsales, alpha2_raw, mdl77_ohistoricalgrowthfactor_pctchg3yocf, probability_dist_bb_plus, normalize` |
| Common operators | `ts_std_dev, zscore, scale, ts_mean, max, ts_backfill, ts_corr, rank` |
...
| Field overlap | Common fields are `alpha1, alpha1_raw, mdl177_valuemomemtummodel_earningsqualitymodule, annualized_pd_3_year_jc7, useStd, alpha3_raw, mdl177_2_globaldevnorthamerica_v502_aspanratio, mdl77_2growthanalystmodel_qga_opmarginsales, alpha2_raw, mdl77_ohistoricalgrowthfactor_pctchg3yocf, probability_dist_bb_plus, normalize`. |
| Operator overlap | Common operators are `ts_std_dev, zscore, scale, ts_mean, max, ts_backfill, ts_corr, rank`. |
