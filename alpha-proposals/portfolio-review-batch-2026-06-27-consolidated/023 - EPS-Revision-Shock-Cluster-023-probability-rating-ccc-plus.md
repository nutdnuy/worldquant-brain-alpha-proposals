---
title: "EPS Revision Shock Cluster 023 - probability_rating_ccc_plus"
...
# EPS Revision Shock Cluster 023 - probability_rating_ccc_plus
...
| Dominant families | price-volume/liquidity/turnover (5), analyst/model scores (5), risk/credit/volatility (5), quality/growth/value (5) |
| Common fields | `alpha1, probability_rating_ccc_plus, alpha4, alpha3, returns, anl4_dez1basicafv4_est, fnd6_newqeventv110_lqpl1q, annualized_pd_2_year_jc7, vwap, alpha2, mdl77_ohistoricalgrowthfactor_fcfequity, mdl77_valueanalystmodelqva_epmodule` |
| Common operators | `signed_power, zscore, ts_rank, winsorize, ts_mean, scale, vec_avg, min, group_neutralize, ts_backfill, ts_corr, rank` |
...
| Field overlap | Common fields are `alpha1, probability_rating_ccc_plus, alpha4, alpha3, returns, anl4_dez1basicafv4_est, fnd6_newqeventv110_lqpl1q, annualized_pd_2_year_jc7, vwap, alpha2, mdl77_ohistoricalgrowthfactor_fcfequity, mdl77_valueanalystmodelqva_epmodule`. |
| Operator overlap | Common operators are `signed_power, zscore, ts_rank, winsorize, ts_mean, scale, vec_avg, min, group_neutralize, ts_backfill, ts_corr, rank`. |
| Family overlap | Dominant workbook families are price-volume/liquidity/turnover (5), analyst/model scores (5), risk/credit/volatility (5), quality/growth/value (5). |
