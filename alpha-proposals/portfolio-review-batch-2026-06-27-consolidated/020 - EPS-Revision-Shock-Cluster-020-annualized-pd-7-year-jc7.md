---
title: "EPS Revision Shock Cluster 020 - annualized_pd_7_year_jc7"
...
# EPS Revision Shock Cluster 020 - annualized_pd_7_year_jc7
...
| Dominant families | quality/growth/value (6), options/implied volatility (6), analyst/model scores (6), price-volume/liquidity/turnover (6), risk/credit/volatility (6) |
| Common fields | `alpha1, annualized_pd_7_year_jc7, alpha1_raw, returns, vwap, alpha3_raw, close, mdl77_ohistoricalgrowthfactor_fcfequity, mdl77_valueanalystmodelqva_epmodule, alpha2_raw, normalize, probability_dist_a_minus` |
| Common operators | `signed_power, zscore, ts_rank, winsorize, ts_mean, scale, ts_std_dev, max, min, group_neutralize, ts_backfill, ts_corr` |
...
| Field overlap | Common fields are `alpha1, annualized_pd_7_year_jc7, alpha1_raw, returns, vwap, alpha3_raw, close, mdl77_ohistoricalgrowthfactor_fcfequity, mdl77_valueanalystmodelqva_epmodule, alpha2_raw, normalize, probability_dist_a_minus`. |
| Operator overlap | Common operators are `signed_power, zscore, ts_rank, winsorize, ts_mean, scale, ts_std_dev, max, min, group_neutralize, ts_backfill, ts_corr`. |
| Family overlap | Dominant workbook families are quality/growth/value (6), options/implied volatility (6), analyst/model scores (6), price-volume/liquidity/turnover (6), risk/credit/volatility (6). |
