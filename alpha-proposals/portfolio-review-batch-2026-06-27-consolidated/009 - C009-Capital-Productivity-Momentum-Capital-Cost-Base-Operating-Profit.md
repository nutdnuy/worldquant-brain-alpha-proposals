---
title: "C009 - Capital Productivity Momentum - Capital Cost Base + Operating Profit"
...
# C009 - Capital Productivity Momentum - Capital Cost Base + Operating Profit
...
| Common fields | `g, cap, c, fnd6_fopo, cogs, op, cost` |
| Common operators | `trade_when, zscore, group_neutralize, abs, winsorize, ts_mean, rank` |
...
| Field overlap | Common fields are `g, cap, c, fnd6_fopo, cogs, op, cost`. |
| Operator overlap | Common operators are `trade_when, zscore, group_neutralize, abs, winsorize, ts_mean, rank`. |
