---
title: "EPS Revision Shock Cluster 025 - limit"
...
# EPS Revision Shock Cluster 025 - limit
...
| Dominant families | quality/growth/value (4), options/implied volatility (4), tax/accounting fundamentals (4), analyst/model scores (4), earnings/EPS/guidance revisions (4) |
| Common fields | `limit, alpha1, eps_previous_estimate_value, alpha1_raw, fnd6_txws, research_development_expense, useStd, alpha3_raw, mdl77_2growthanalystmodel_qga_opmarginsales, alpha2_raw, mdl177_valuemomemtummodel_earningsqualitymodule, normalize` |
| Common operators | `ts_std_dev, scale, ts_mean, vec_avg, max, group_rank, ts_decay_linear, group_neutralize, ts_backfill, ts_corr, rank, zscore` |
...
| Field overlap | Common fields are `limit, alpha1, eps_previous_estimate_value, alpha1_raw, fnd6_txws, research_development_expense, useStd, alpha3_raw, mdl77_2growthanalystmodel_qga_opmarginsales, alpha2_raw, mdl177_valuemomemtummodel_earningsqualitymodule, normalize`. |
| Operator overlap | Common operators are `ts_std_dev, scale, ts_mean, vec_avg, max, group_rank, ts_decay_linear, group_neutralize, ts_backfill, ts_corr, rank, zscore`. |
| Family overlap | Dominant workbook families are quality/growth/value (4), options/implied volatility (4), tax/accounting fundamentals (4), analyst/model scores (4), earnings/EPS/guidance revisions (4). |
