---
title: "C055 - EPS Revision Shock - Earnings Quality + Analyst Margin Sales + Tax Working Spread + 4Y Credit PD + A+ Rating"
type: alpha-cluster-proposal
project: worldquant-brain
proposal_batch: portfolio-review-2026-06-27-consolidated
cluster_id: cluster-055
member_count: 2
...
# C055 - EPS Revision Shock - Earnings Quality + Analyst Margin Sales + Tax Working Spread + 4Y Credit PD + A+ Rating
...
| Common fields | `alpha3_raw, alpha2_raw, annualized_pd_4_year_jc7, alpha1_raw, mdl177_valuemomemtummodel_earningsqualitymodule, alpha1, fnd6_txws, mdl77_2growthanalystmodel_qga_opmarginsales, normalize, probability_dist_a_plus, limit, useStd` |
| Common operators | `max, group_rank, ts_corr, zscore, vec_avg, ts_mean, ts_decay_linear, ts_std_dev, scale, ts_backfill, group_neutralize` |
...
| Field overlap | Common fields are `alpha3_raw, alpha2_raw, annualized_pd_4_year_jc7, alpha1_raw, mdl177_valuemomemtummodel_earningsqualitymodule, alpha1, fnd6_txws, mdl77_2growthanalystmodel_qga_opmarginsales, normalize, probability_dist_a_plus, limit, useStd`. |
| Operator overlap | Common operators are `max, group_rank, ts_corr, zscore, vec_avg, ts_mean, ts_decay_linear, ts_std_dev, scale, ts_backfill, group_neutralize`. |
