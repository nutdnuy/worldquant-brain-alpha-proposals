---
title: "EPS Revision Shock Cluster 092 - limit"
type: alpha-cluster-proposal
project: worldquant-brain
proposal_batch: portfolio-review-2026-06-27-consolidated
cluster_id: cluster-092
member_count: 2
cluster_basis: "exact-expression duplicate"
representative_alpha: "EPS Revision Shock Variant 85"
created: 2026-06-27
updated: 2026-06-27
---

# EPS Revision Shock Cluster 092 - limit
...
>
> **Representative candidate.** EPS Revision Shock Variant 85 is the current representative because it has the strongest recorded status/priority/metric profile inside this cluster.
>
...
| Common fields | `limit, alpha1, alpha1_raw, annualized_pd_3_year_jc7, useStd, alpha3_raw, earnings_per_share_reported, mdl77_ohistoricalgrowthfactor_fcfequity, mdl77_valueanalystmodelqva_epmodule, alpha2_raw, probability_dist_bb_plus, normalize` |
| Common operators | `ts_std_dev, scale, ts_mean, max, group_rank, group_neutralize, ts_backfill, ts_corr, rank, ts_arg_max` |
| Best recorded Sharpe | `2.35` |
| Best recorded Fitness | `2.5` |
| Median turnover | `10.88%` |
| Representative | EPS Revision Shock Variant 85 |
...
| Field overlap | Common fields are `limit, alpha1, alpha1_raw, annualized_pd_3_year_jc7, useStd, alpha3_raw, earnings_per_share_reported, mdl77_ohistoricalgrowthfactor_fcfequity, mdl77_valueanalystmodelqva_epmodule, alpha2_raw, probability_dist_bb_plus, normalize`. |
| Operator overlap | Common operators are `ts_std_dev, scale, ts_mean, max, group_rank, group_neutralize, ts_backfill, ts_corr, rank, ts_arg_max`. |
