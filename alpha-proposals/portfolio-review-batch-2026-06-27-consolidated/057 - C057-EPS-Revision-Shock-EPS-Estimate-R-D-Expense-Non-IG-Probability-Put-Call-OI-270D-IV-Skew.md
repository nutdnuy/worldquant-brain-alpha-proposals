---
title: "C057 - EPS Revision Shock - EPS Estimate + R&D Expense + Non-IG Probability + Put-Call OI + 270D IV Skew"
...
# C057 - EPS Revision Shock - EPS Estimate + R&D Expense + Non-IG Probability + Put-Call OI + 270D IV Skew
...
| Dominant families | risk/credit/volatility (2), quality/growth/value (2), earnings/EPS/guidance revisions (2), options/implied volatility (2) |
| Common fields | `implied_volatility_put_270, direction, eps_previous_estimate_value, pcr_oi_270, implied_volatility_call_270, research_development_expense, weight_raw, probability_non_investment_grade_rating, conviction, weight_strength, alphamix` |
| Common operators | `if_else, group_zscore, group_rank, ts_corr, rank, abs, vec_avg, ts_mean, trade_when, ts_backfill, group_neutralize` |
...
| Field overlap | Common fields are `implied_volatility_put_270, direction, eps_previous_estimate_value, pcr_oi_270, implied_volatility_call_270, research_development_expense, weight_raw, probability_non_investment_grade_rating, conviction, weight_strength, alphamix`. |
| Operator overlap | Common operators are `if_else, group_zscore, group_rank, ts_corr, rank, abs, vec_avg, ts_mean, trade_when, ts_backfill, group_neutralize`. |
| Family overlap | Dominant workbook families are risk/credit/volatility (2), quality/growth/value (2), earnings/EPS/guidance revisions (2), options/implied volatility (2). |
