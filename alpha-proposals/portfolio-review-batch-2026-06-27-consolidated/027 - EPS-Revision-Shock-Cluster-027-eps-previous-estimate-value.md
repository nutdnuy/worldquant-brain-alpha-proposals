---
title: "EPS Revision Shock Cluster 027 - eps_previous_estimate_value"
...
# EPS Revision Shock Cluster 027 - eps_previous_estimate_value
...
| Dominant families | quality/growth/value (4), options/implied volatility (4), tax/accounting fundamentals (4), risk/credit/volatility (4), earnings/EPS/guidance revisions (4) |
| Common fields | `alpha1, eps_previous_estimate_value, pcr_oi_270, alpha1_raw, implied_volatility_call_270, fnd6_txws, research_development_expense, implied_volatility_put_270, alpha3_raw, alpha2_raw, probability_non_investment_grade_rating, normalize` |
| Common operators | `ts_std_dev, scale, ts_mean, vec_avg, max, group_zscore, group_rank, ts_decay_linear, group_neutralize, ts_backfill, ts_corr, rank` |
...
| Field overlap | Common fields are `alpha1, eps_previous_estimate_value, pcr_oi_270, alpha1_raw, implied_volatility_call_270, fnd6_txws, research_development_expense, implied_volatility_put_270, alpha3_raw, alpha2_raw, probability_non_investment_grade_rating, normalize`. |
| Operator overlap | Common operators are `ts_std_dev, scale, ts_mean, vec_avg, max, group_zscore, group_rank, ts_decay_linear, group_neutralize, ts_backfill, ts_corr, rank`. |
| Family overlap | Dominant workbook families are quality/growth/value (4), options/implied volatility (4), tax/accounting fundamentals (4), risk/credit/volatility (4), earnings/EPS/guidance revisions (4). |
