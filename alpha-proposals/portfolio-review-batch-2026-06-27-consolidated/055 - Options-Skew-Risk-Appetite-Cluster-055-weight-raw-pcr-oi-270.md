---
title: "Options Skew Risk Appetite Cluster 055 - weight_raw pcr_oi_270"
...
# Options Skew Risk Appetite Cluster 055 - weight_raw pcr_oi_270
...
| Dominant families | options/implied volatility (2), analyst/model scores (2), risk/credit/volatility (2) |
| Common fields | `weight_raw, pcr_oi_270, probability_dist_aa_plus, implied_volatility_call_60, weight_strength, conviction, alphamix, direction, mdl53_ms5_6month, implied_volatility_put_60` |
...
| Field overlap | Common fields are `weight_raw, pcr_oi_270, probability_dist_aa_plus, implied_volatility_call_60, weight_strength, conviction, alphamix, direction, mdl53_ms5_6month, implied_volatility_put_60`. |
| Operator overlap | Common operators are `ts_backfill, if_else, abs, group_zscore, ts_mean, ts_corr, rank, trade_when`. |
| Family overlap | Dominant workbook families are options/implied volatility (2), analyst/model scores (2), risk/credit/volatility (2). |
