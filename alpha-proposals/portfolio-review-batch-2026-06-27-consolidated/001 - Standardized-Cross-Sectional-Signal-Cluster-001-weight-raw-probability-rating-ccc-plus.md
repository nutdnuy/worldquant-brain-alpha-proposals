---
title: "Standardized Cross Sectional Signal Cluster 001 - weight_raw probability_rating_ccc_plus"
...
# Standardized Cross Sectional Signal Cluster 001 - weight_raw probability_rating_ccc_plus
...
| Dominant families | tax/accounting fundamentals (43), risk/credit/volatility (43) |
| Common fields | `weight_raw, probability_rating_ccc_plus, fnd6_txws, annualized_pd_2_year_jc7, weight_strength, conviction, alphamix, direction` |
| Common operators | `if_else, zscore, vec_avg, abs, ts_decay_linear, group_rank, group_neutralize, ts_backfill, rank` |
...
| Field overlap | Common fields are `weight_raw, probability_rating_ccc_plus, fnd6_txws, annualized_pd_2_year_jc7, weight_strength, conviction, alphamix, direction`. |
| Operator overlap | Common operators are `if_else, zscore, vec_avg, abs, ts_decay_linear, group_rank, group_neutralize, ts_backfill, rank`. |
| Family overlap | Dominant workbook families are tax/accounting fundamentals (43), risk/credit/volatility (43). |
