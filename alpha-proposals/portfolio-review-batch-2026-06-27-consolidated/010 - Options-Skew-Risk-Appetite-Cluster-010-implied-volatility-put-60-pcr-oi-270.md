---
title: "Options Skew Risk Appetite Cluster 010 - implied_volatility_put_60 pcr_oi_270"
...
# Options Skew Risk Appetite Cluster 010 - implied_volatility_put_60 pcr_oi_270
...
| Dominant families | options/implied volatility (8), risk/credit/volatility (8) |
| Common fields | `implied_volatility_put_60, pcr_oi_270, implied_volatility_call_60` |
| Common operators | `ts_mean, group_zscore, trade_when` |
| Best recorded Sharpe | `2.69` |
| Best recorded Fitness | `3.49` |
| Median turnover | `17.61%` |
...
| Field overlap | Common fields are `implied_volatility_put_60, pcr_oi_270, implied_volatility_call_60`. |
| Operator overlap | Common operators are `ts_mean, group_zscore, trade_when`. |
| Family overlap | Dominant workbook families are options/implied volatility (8), risk/credit/volatility (8). |
