---
title: "Price Volume Reversal Cluster 065 - anl4_detailrecv4_est probability_dist_b"
type: alpha-cluster-proposal
project: worldquant-brain
proposal_batch: portfolio-review-2026-06-27-consolidated
cluster_id: cluster-065
member_count: 2
...
# Price Volume Reversal Cluster 065 - anl4_detailrecv4_est probability_dist_b
...
| Dominant families | price-volume/liquidity/turnover (2), tax/accounting fundamentals (2), risk/credit/volatility (2), analyst/model scores (2) |
| Common fields | `anl4_detailrecv4_est, probability_dist_b, returns, volume, p1_raw, p3_raw, p1, anl4_netdebt_number, annualized_pd_1_year_jc7, p2_raw, p2, reverse` |
| Common operators | `zscore, multiply, add, ts_zscore, divide, vec_avg, ts_decay_linear, group_neutralize, ts_backfill, ts_corr, rank, scale` |
...
| Field overlap | Common fields are `anl4_detailrecv4_est, probability_dist_b, returns, volume, p1_raw, p3_raw, p1, anl4_netdebt_number, annualized_pd_1_year_jc7, p2_raw, p2, reverse`. |
| Operator overlap | Common operators are `zscore, multiply, add, ts_zscore, divide, vec_avg, ts_decay_linear, group_neutralize, ts_backfill, ts_corr, rank, scale`. |
| Family overlap | Dominant workbook families are price-volume/liquidity/turnover (2), tax/accounting fundamentals (2), risk/credit/volatility (2), analyst/model scores (2). |
