---
title: "C022 - Options Skew Risk Appetite - Put-Call OI + 60D IV Skew + 270D IV Skew + Non-IG Probability"
...
# C022 - Options Skew Risk Appetite - Put-Call OI + 60D IV Skew + 270D IV Skew + Non-IG Probability
...
| Dominant families | risk/credit/volatility (5), options/implied volatility (5) |
| Common fields | `implied_volatility_put_60, direction, implied_volatility_put_270, pcr_oi_270, implied_volatility_call_60, implied_volatility_call_270, weight_raw, probability_non_investment_grade_rating, conviction, weight_strength, alphamix` |
| Common operators | `if_else, group_zscore, rank, abs, ts_mean, trade_when, ts_backfill, group_neutralize` |
...
| Field overlap | Common fields are `implied_volatility_put_60, direction, implied_volatility_put_270, pcr_oi_270, implied_volatility_call_60, implied_volatility_call_270, weight_raw, probability_non_investment_grade_rating, conviction, weight_strength, alphamix`. |
| Operator overlap | Common operators are `if_else, group_zscore, rank, abs, ts_mean, trade_when, ts_backfill, group_neutralize`. |
| Family overlap | Dominant workbook families are risk/credit/volatility (5), options/implied volatility (5). |
