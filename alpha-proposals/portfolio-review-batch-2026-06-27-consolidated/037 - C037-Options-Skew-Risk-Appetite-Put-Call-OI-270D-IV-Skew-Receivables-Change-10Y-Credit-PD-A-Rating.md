---
title: "C037 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew + Receivables Change + 10Y Credit PD + A Rating"
...
# C037 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew + Receivables Change + 10Y Credit PD + A Rating
...
| Dominant families | risk/credit/volatility (3), price-volume/liquidity/turnover (3), analyst/model scores (3), options/implied volatility (3), tax/accounting fundamentals (3) |
| Common fields | `alpha4, implied_volatility_put_270, annualized_pd_10_year_jc7, alpha2, anl4_netdebt_number, pcr_oi_270, implied_volatility_call_270, alpha1, probability_dist_a, probability_non_investment_grade_rating, alpha3, anl4_detailrecv4_est` |
...
| Field overlap | Common fields are `alpha4, implied_volatility_put_270, annualized_pd_10_year_jc7, alpha2, anl4_netdebt_number, pcr_oi_270, implied_volatility_call_270, alpha1, probability_dist_a, probability_non_investment_grade_rating, alpha3, anl4_detailrecv4_est`. |
...
| Family overlap | Dominant workbook families are risk/credit/volatility (3), price-volume/liquidity/turnover (3), analyst/model scores (3), options/implied volatility (3), tax/accounting fundamentals (3). |
