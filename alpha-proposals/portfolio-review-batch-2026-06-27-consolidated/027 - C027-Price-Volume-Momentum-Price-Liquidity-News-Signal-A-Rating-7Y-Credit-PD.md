---
title: "C027 - Price Volume Momentum - Price Liquidity + News Signal + A- Rating + 7Y Credit PD"
...
representative_alpha: "Price Volume Momentum"
created: 2026-06-27
updated: 2026-06-27
---

# C027 - Price Volume Momentum - Price Liquidity + News Signal + A- Rating + 7Y Credit PD
...
>
> **Representative candidate.** Price Volume Momentum is the current representative because it has the strongest recorded status/priority/metric profile inside this cluster.
>
...
| Dominant families | risk/credit/volatility (4), news/sentiment/buzz (4), price-volume/liquidity/turnover (4) |
| Common fields | `alpha3, returns, annualized_pd_7_year_jc7, alpha1_scaled, alpha2, alpha1, alpha2_scaled, nws12_afterhsz_sl, vwap, close, alpha3_scaled, probability_dist_aaa` |
| Common operators | `ts_delta, min, ts_rank, max, ts_corr, rank, ts_sum, vec_avg, ts_mean, ts_std_dev, scale, ts_backfill` |
| Best recorded Sharpe | `2.21` |
| Best recorded Fitness | `2.82` |
| Median turnover | `18.14%` |
| Representative | Price Volume Momentum |
...
| Field overlap | Common fields are `alpha3, returns, annualized_pd_7_year_jc7, alpha1_scaled, alpha2, alpha1, alpha2_scaled, nws12_afterhsz_sl, vwap, close, alpha3_scaled, probability_dist_aaa`. |
...
| Family overlap | Dominant workbook families are risk/credit/volatility (4), news/sentiment/buzz (4), price-volume/liquidity/turnover (4). |
...
| ---: | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- |
| 118 | Price Volume Momentum | `rKWJMk01` | `hard_pass_signal_seed` | `2.21` | `2.82` | `13.60%` | `n/a` | `SELF_CORRELATION` | `ff8cfd19df78d8e6` |
| 177 | Price Volume Momentum Variant 2 | `e7rdMLNp` | `hard_pass_signal_seed` | `2.17` | `2.55` | `15.60%` | `n/a` | `SELF_CORRELATION` | `c35ef37eab2f7cac` |
| 259 | Price Volume Momentum Variant 6 | `d5QPwr2w` | `hard_pass_signal_seed` | `2.11` | `2.26` | `18.14%` | `n/a` | `SELF_CORRELATION` | `29e9df3c9ff49af3` |
| 263 | Price Volume Momentum Variant 7 | `le0lrK08` | `hard_pass_signal_seed` | `2.11` | `2.25` | `18.14%` | `n/a` | `SELF_CORRELATION` | `29e9df3c9ff49af3` |
