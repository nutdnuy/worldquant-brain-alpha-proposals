---
title: "EPS Revision Shock Cluster 088 - anl4_detailrecv4_est"
type: alpha-cluster-proposal
project: worldquant-brain
proposal_batch: portfolio-review-2026-06-27-consolidated
cluster_id: cluster-088
member_count: 2
...
# EPS Revision Shock Cluster 088 - anl4_detailrecv4_est
...
| Dominant families | quality/growth/value (2), options/implied volatility (2), tax/accounting fundamentals (2), analyst/model scores (2), risk/credit/volatility (2) |
| Common fields | `alpha1, anl4_detailrecv4_est, alpha1_raw, mdl77_valueanalystmodelqva_epmodule, anl4_netdebt_number, alpha3_raw, useStd, mdl77_ohistoricalgrowthfactor_fcfequity, annualized_pd_10_year_jc7, alpha2_raw, probability_dist_a, normalize` |
| Common operators | `signed_power, zscore, scale, winsorize, ts_std_dev, ts_mean, vec_avg, max, group_neutralize, ts_backfill, ts_corr, rank` |
...
| Field overlap | Common fields are `alpha1, anl4_detailrecv4_est, alpha1_raw, mdl77_valueanalystmodelqva_epmodule, anl4_netdebt_number, alpha3_raw, useStd, mdl77_ohistoricalgrowthfactor_fcfequity, annualized_pd_10_year_jc7, alpha2_raw, probability_dist_a, normalize`. |
| Operator overlap | Common operators are `signed_power, zscore, scale, winsorize, ts_std_dev, ts_mean, vec_avg, max, group_neutralize, ts_backfill, ts_corr, rank`. |
| Family overlap | Dominant workbook families are quality/growth/value (2), options/implied volatility (2), tax/accounting fundamentals (2), analyst/model scores (2), risk/credit/volatility (2). |
