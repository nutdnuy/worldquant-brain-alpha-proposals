---
title: "C013 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew + Receivables Change + Historical Growth + Analyst Basic Estimate"
...
# C013 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew + Receivables Change + Historical Growth + Analyst Basic Estimate
...
| Dominant families | risk/credit/volatility (7), price-volume/liquidity/turnover (7), analyst/model scores (7), quality/growth/value (7), options/implied volatility (7) |
| Common fields | `unexpected_change_accounts_receivable, implied_volatility_put_270, p1_raw, implied_volatility_call_270, pcr_oi_270, mdl77_historicalgrowthfactor_y3speq4rqsr, reverse, p1, probability_non_investment_grade_rating, p2, p2_raw, p3_raw` |
| Common operators | `ts_decay_linear, multiply, divide, group_zscore, ts_corr, zscore, add, group_rank, rank, ts_zscore, vec_avg, ts_mean` |
...
| Field overlap | Common fields are `unexpected_change_accounts_receivable, implied_volatility_put_270, p1_raw, implied_volatility_call_270, pcr_oi_270, mdl77_historicalgrowthfactor_y3speq4rqsr, reverse, p1, probability_non_investment_grade_rating, p2, p2_raw, p3_raw`. |
| Operator overlap | Common operators are `ts_decay_linear, multiply, divide, group_zscore, ts_corr, zscore, add, group_rank, rank, ts_zscore, vec_avg, ts_mean`. |
| Family overlap | Dominant workbook families are risk/credit/volatility (7), price-volume/liquidity/turnover (7), analyst/model scores (7), quality/growth/value (7), options/implied volatility (7). |
