---
title: "C007 - Fundamental Score Momentum - Multi-Factor Score Delta"
...
# C007 - Fundamental Score Momentum - Multi-Factor Score Delta
...
| Common operators | `rank, ts_backfill, ts_zscore` |
...
| Operator overlap | Common operators are `rank, ts_backfill, ts_zscore`. |
