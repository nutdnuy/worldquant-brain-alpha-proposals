---
title: "Cross Sectional Signal Momentum Cluster 061 - weight_raw fnd6_txws"
...
# Cross Sectional Signal Momentum Cluster 061 - weight_raw fnd6_txws
...
| Dominant families | price-volume/liquidity/turnover (2), tax/accounting fundamentals (2), earnings/EPS/guidance revisions (2) |
| Common fields | `weight_raw, fnd6_txws, min_free_cash_flow_per_share_guidance, weight_strength, conviction, alphamix, direction` |
| Common operators | `if_else, vec_avg, abs, ts_decay_linear, group_rank, group_neutralize, ts_backfill, rank, ts_arg_max` |
...
| Field overlap | Common fields are `weight_raw, fnd6_txws, min_free_cash_flow_per_share_guidance, weight_strength, conviction, alphamix, direction`. |
| Operator overlap | Common operators are `if_else, vec_avg, abs, ts_decay_linear, group_rank, group_neutralize, ts_backfill, rank, ts_arg_max`. |
| Family overlap | Dominant workbook families are price-volume/liquidity/turnover (2), tax/accounting fundamentals (2), earnings/EPS/guidance revisions (2). |
