---
title: "Options Skew Risk Appetite Cluster 094 - implied_volatility_call_270"
type: alpha-cluster-proposal
project: worldquant-brain
proposal_batch: portfolio-review-2026-06-27-consolidated
cluster_id: cluster-094
member_count: 2
...
# Options Skew Risk Appetite Cluster 094 - implied_volatility_call_270
...
| Common fields | `alpha1, implied_volatility_call_270, pcr_oi_270, alpha1_raw, fnd6_txws, annualized_pd_3_year_jc7, implied_volatility_put_270, alpha3_raw, alpha2_raw, probability_non_investment_grade_rating, probability_dist_bb_plus, normalize` |
| Common operators | `ts_std_dev, scale, ts_mean, vec_avg, max, group_zscore, ts_decay_linear, group_rank, ts_backfill, ts_corr, rank, trade_when` |
...
| Field overlap | Common fields are `alpha1, implied_volatility_call_270, pcr_oi_270, alpha1_raw, fnd6_txws, annualized_pd_3_year_jc7, implied_volatility_put_270, alpha3_raw, alpha2_raw, probability_non_investment_grade_rating, probability_dist_bb_plus, normalize`. |
| Operator overlap | Common operators are `ts_std_dev, scale, ts_mean, vec_avg, max, group_zscore, ts_decay_linear, group_rank, ts_backfill, ts_corr, rank, trade_when`. |
