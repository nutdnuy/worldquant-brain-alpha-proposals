---
title: "C034 - EPS Revision Shock - EPS Estimate"
...
# C034 - EPS Revision Shock - EPS Estimate
...
| Dominant families | earnings/EPS/guidance revisions (4), price-volume/liquidity/turnover (4) |
| Common fields | `close, est_epsr` |
| Common operators | `ts_rank, ts_backfill, group_rank` |
...
| Field overlap | Common fields are `close, est_epsr`. |
| Operator overlap | Common operators are `ts_rank, ts_backfill, group_rank`. |
| Family overlap | Dominant workbook families are earnings/EPS/guidance revisions (4), price-volume/liquidity/turnover (4). |
