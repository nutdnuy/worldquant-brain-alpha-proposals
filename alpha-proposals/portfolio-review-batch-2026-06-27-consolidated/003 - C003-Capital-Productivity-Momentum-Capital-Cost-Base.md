---
title: "C003 - Capital Productivity Momentum - Capital Cost Base"
...
# C003 - Capital Productivity Momentum - Capital Cost Base
...
| Common fields | `cap, g, cogs, c, c0` |
| Common operators | `zscore, abs, rank, trade_when, ts_mean, winsorize` |
...
| Field overlap | Common fields are `cap, g, cogs, c, c0`. |
| Operator overlap | Common operators are `zscore, abs, rank, trade_when, ts_mean, winsorize`. |
