---
title: "C078 - Price Volume Reversal - Price Liquidity + 10Y Credit PD + A Rating"
...
# C078 - Price Volume Reversal - Price Liquidity + 10Y Credit PD + A Rating
...
| Common fields | `returns, direction, annualized_pd_10_year_jc7, weight_raw, probability_dist_a, vwap, weight_strength, conviction, close, alphamix` |
| Common operators | `min, if_else, ts_rank, ts_corr, rank, abs, ts_mean, ts_backfill` |
...
| Field overlap | Common fields are `returns, direction, annualized_pd_10_year_jc7, weight_raw, probability_dist_a, vwap, weight_strength, conviction, close, alphamix`. |
| Operator overlap | Common operators are `min, if_else, ts_rank, ts_corr, rank, abs, ts_mean, ts_backfill`. |
