---
title: "Options Skew Risk Appetite Cluster 075 - implied_volatility_put_30 weight_raw"
...
# Options Skew Risk Appetite Cluster 075 - implied_volatility_put_30 weight_raw
...
| Dominant families | options/implied volatility (2), analyst/model scores (2), risk/credit/volatility (2), price-volume/liquidity/turnover (2) |
| Common fields | `implied_volatility_put_30, weight_raw, weight_strength, conviction, implied_volatility_call_30, alphamix, direction, mdl77_liquidityriskfactor_astcomp` |
| Common operators | `ts_std_dev, ts_backfill, if_else, abs, group_zscore, group_neutralize, ts_mean, rank` |
...
| Field overlap | Common fields are `implied_volatility_put_30, weight_raw, weight_strength, conviction, implied_volatility_call_30, alphamix, direction, mdl77_liquidityriskfactor_astcomp`. |
| Operator overlap | Common operators are `ts_std_dev, ts_backfill, if_else, abs, group_zscore, group_neutralize, ts_mean, rank`. |
| Family overlap | Dominant workbook families are options/implied volatility (2), analyst/model scores (2), risk/credit/volatility (2), price-volume/liquidity/turnover (2). |
