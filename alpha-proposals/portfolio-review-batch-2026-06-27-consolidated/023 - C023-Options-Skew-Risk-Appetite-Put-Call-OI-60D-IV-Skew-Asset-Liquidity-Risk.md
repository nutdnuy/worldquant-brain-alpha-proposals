---
title: "C023 - Options Skew Risk Appetite - Put-Call OI + 60D IV Skew + Asset Liquidity Risk"
...
# C023 - Options Skew Risk Appetite - Put-Call OI + 60D IV Skew + Asset Liquidity Risk
...
| Dominant families | risk/credit/volatility (5), analyst/model scores (5), price-volume/liquidity/turnover (5), options/implied volatility (5) |
| Common fields | `implied_volatility_put_60, direction, pcr_oi_270, implied_volatility_call_60, mdl77_liquidityriskfactor_astcomp, weight_raw, conviction, weight_strength, alphamix` |
| Common operators | `if_else, group_zscore, ts_backfill, rank, abs, trade_when, ts_std_dev, ts_mean, group_neutralize` |
...
| Field overlap | Common fields are `implied_volatility_put_60, direction, pcr_oi_270, implied_volatility_call_60, mdl77_liquidityriskfactor_astcomp, weight_raw, conviction, weight_strength, alphamix`. |
| Operator overlap | Common operators are `if_else, group_zscore, ts_backfill, rank, abs, trade_when, ts_std_dev, ts_mean, group_neutralize`. |
| Family overlap | Dominant workbook families are risk/credit/volatility (5), analyst/model scores (5), price-volume/liquidity/turnover (5), options/implied volatility (5). |
