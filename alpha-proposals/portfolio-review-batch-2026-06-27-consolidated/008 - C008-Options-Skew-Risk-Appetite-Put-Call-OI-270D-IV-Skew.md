---
title: "C008 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew"
...
# C008 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew
...
| Common fields | `pcr_oi_270, implied_volatility_call_270, implied_volatility_put_270` |
| Common operators | `trade_when, group_zscore, ts_mean` |
...
| Field overlap | Common fields are `pcr_oi_270, implied_volatility_call_270, implied_volatility_put_270`. |
| Operator overlap | Common operators are `trade_when, group_zscore, ts_mean`. |
