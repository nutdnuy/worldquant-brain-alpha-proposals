---
title: "C061 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew + Non-IG Probability + 5Y Credit PD + 10Y Credit PD"
type: alpha-cluster-proposal
project: worldquant-brain
proposal_batch: portfolio-review-2026-06-27-consolidated
cluster_id: cluster-061
member_count: 2
...
# C061 - Options Skew Risk Appetite - Put-Call OI + 270D IV Skew + Non-IG Probability + 5Y Credit PD + 10Y Credit PD
...
| Common fields | `ts_av_diff, annualized_pd_4_year_jc7, implied_volatility_put_270, direction, pcr_oi_270, implied_volatility_call_270, weight_raw, probability_non_investment_grade_rating, annualized_pd_5_year_ms5, weight_strength, conviction, annualized_pd_10_year_ms5` |
| Common operators | `if_else, group_zscore, ts_corr, rank, abs, ts_mean, trade_when, ts_backfill` |
...
| Field overlap | Common fields are `ts_av_diff, annualized_pd_4_year_jc7, implied_volatility_put_270, direction, pcr_oi_270, implied_volatility_call_270, weight_raw, probability_non_investment_grade_rating, annualized_pd_5_year_ms5, weight_strength, conviction, annualized_pd_10_year_ms5`. |
| Operator overlap | Common operators are `if_else, group_zscore, ts_corr, rank, abs, ts_mean, trade_when, ts_backfill`. |
