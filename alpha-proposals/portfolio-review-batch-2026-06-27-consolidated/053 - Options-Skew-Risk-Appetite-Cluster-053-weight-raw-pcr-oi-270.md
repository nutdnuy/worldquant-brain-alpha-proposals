---
title: "Options Skew Risk Appetite Cluster 053 - weight_raw pcr_oi_270"
type: alpha-cluster-proposal
project: worldquant-brain
proposal_batch: portfolio-review-2026-06-27-consolidated
cluster_id: cluster-053
member_count: 2
cluster_basis: "same-field same-operator variant"
representative_alpha: "Options Skew Risk Appetite Variant 5"
created: 2026-06-27
updated: 2026-06-27
---

# Options Skew Risk Appetite Cluster 053 - weight_raw pcr_oi_270
...
>
> **Representative candidate.** Options Skew Risk Appetite Variant 5 is the current representative because it has the strongest recorded status/priority/metric profile inside this cluster.
>
...
| Common fields | `weight_raw, pcr_oi_270, returns, implied_volatility_call_60, vwap, weight_strength, conviction, close, alphamix, direction, implied_volatility_put_60` |
| Common operators | `ts_rank, if_else, abs, group_zscore, min, ts_mean, rank, trade_when` |
| Best recorded Sharpe | `2.6` |
| Best recorded Fitness | `3.07` |
| Median turnover | `16.74%` |
| Representative | Options Skew Risk Appetite Variant 5 |
...
| Field overlap | Common fields are `weight_raw, pcr_oi_270, returns, implied_volatility_call_60, vwap, weight_strength, conviction, close, alphamix, direction, implied_volatility_put_60`. |
| Operator overlap | Common operators are `ts_rank, if_else, abs, group_zscore, min, ts_mean, rank, trade_when`. |
