---
title: "Price Volume Momentum Cluster 049 - probability_dist_a_minus"
...
# Price Volume Momentum Cluster 049 - probability_dist_a_minus
...
| Dominant families | price-volume/liquidity/turnover (3), tax/accounting fundamentals (3), risk/credit/volatility (3), news/sentiment/buzz (3) |
| Common fields | `probability_dist_a_minus, alpha1, alpha1_scaled, alpha3, fnd6_txws, nws12_afterhsz_sl, alpha3_scaled, close, alpha2, annualized_pd_6_month_jc7, alpha2_scaled, alpha1_ret` |
| Common operators | `ts_std_dev, scale, ts_mean, ts_delta, vec_avg, max, ts_decay_linear, group_rank, group_neutralize, ts_backfill, ts_corr, rank` |
...
| Field overlap | Common fields are `probability_dist_a_minus, alpha1, alpha1_scaled, alpha3, fnd6_txws, nws12_afterhsz_sl, alpha3_scaled, close, alpha2, annualized_pd_6_month_jc7, alpha2_scaled, alpha1_ret`. |
| Operator overlap | Common operators are `ts_std_dev, scale, ts_mean, ts_delta, vec_avg, max, ts_decay_linear, group_rank, group_neutralize, ts_backfill, ts_corr, rank`. |
| Family overlap | Dominant workbook families are price-volume/liquidity/turnover (3), tax/accounting fundamentals (3), risk/credit/volatility (3), news/sentiment/buzz (3). |
