---
title: "Options Skew Risk Appetite Cluster 082 - implied_volatility_call_270"
...
# Options Skew Risk Appetite Cluster 082 - implied_volatility_call_270
...
| Dominant families | options/implied volatility (2), tax/accounting fundamentals (2), risk/credit/volatility (2), analyst/model scores (2) |
| Common fields | `alpha1, implied_volatility_call_270, anl4_detailrecv4_est, alpha1_raw, pcr_oi_270, implied_volatility_put_270, anl4_netdebt_number, probability_rating_bbb_plus, alpha3_raw, annualized_pd_10_year_jc7, alpha2_raw, probability_non_investment_grade_rating` |
| Common operators | `ts_std_dev, scale, ts_mean, vec_avg, max, group_zscore, group_neutralize, ts_backfill, ts_corr, rank, trade_when` |
...
| Field overlap | Common fields are `alpha1, implied_volatility_call_270, anl4_detailrecv4_est, alpha1_raw, pcr_oi_270, implied_volatility_put_270, anl4_netdebt_number, probability_rating_bbb_plus, alpha3_raw, annualized_pd_10_year_jc7, alpha2_raw, probability_non_investment_grade_rating`. |
| Operator overlap | Common operators are `ts_std_dev, scale, ts_mean, vec_avg, max, group_zscore, group_neutralize, ts_backfill, ts_corr, rank, trade_when`. |
| Family overlap | Dominant workbook families are options/implied volatility (2), tax/accounting fundamentals (2), risk/credit/volatility (2), analyst/model scores (2). |
