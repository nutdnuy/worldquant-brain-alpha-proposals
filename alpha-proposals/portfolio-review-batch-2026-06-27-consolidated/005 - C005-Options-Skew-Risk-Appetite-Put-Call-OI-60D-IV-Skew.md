---
title: "C005 - Options Skew Risk Appetite - Put-Call OI + 60D IV Skew"
...
# C005 - Options Skew Risk Appetite - Put-Call OI + 60D IV Skew
...
| Dominant families | risk/credit/volatility (8), options/implied volatility (8) |
| Common fields | `implied_volatility_put_60, implied_volatility_call_60, pcr_oi_270` |
...
| Field overlap | Common fields are `implied_volatility_put_60, implied_volatility_call_60, pcr_oi_270`. |
| Operator overlap | Common operators are `ts_mean, trade_when, group_zscore`. |
| Family overlap | Dominant workbook families are risk/credit/volatility (8), options/implied volatility (8). |
