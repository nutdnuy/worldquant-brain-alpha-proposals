---
title: "C058 - Options Skew Risk Appetite - 30D IV Skew + News Signal + Capital Cost Base"
...
# C058 - Options Skew Risk Appetite - 30D IV Skew + News Signal + Capital Cost Base
...
| Dominant families | risk/credit/volatility (2), price-volume/liquidity/turnover (2), options/implied volatility (2), news/sentiment/buzz (2), tax/accounting fundamentals (2) |
| Common fields | `implied_volatility_call_30, cap, cogs, _s3_cogs_s, s2, s3, _s3_cogs_g, s1, implied_volatility_put_30, _s3_cogs_r, close, open` |
| Common operators | `ts_delta, group_zscore, zscore, ts_backfill, rank, abs, ts_sum, vec_avg, trade_when, ts_mean` |
...
| Field overlap | Common fields are `implied_volatility_call_30, cap, cogs, _s3_cogs_s, s2, s3, _s3_cogs_g, s1, implied_volatility_put_30, _s3_cogs_r, close, open`. |
| Operator overlap | Common operators are `ts_delta, group_zscore, zscore, ts_backfill, rank, abs, ts_sum, vec_avg, trade_when, ts_mean`. |
| Family overlap | Dominant workbook families are risk/credit/volatility (2), price-volume/liquidity/turnover (2), options/implied volatility (2), news/sentiment/buzz (2), tax/accounting fundamentals (2). |
