---
title: "C051 - Cross Sectional Signal Momentum - Tax Working Spread + 60D Idio Risk"
type: alpha-cluster-proposal
project: worldquant-brain
proposal_batch: portfolio-review-2026-06-27-consolidated
cluster_id: cluster-051
member_count: 2
...
# C051 - Cross Sectional Signal Momentum - Tax Working Spread + 60D Idio Risk
...
| Common fields | `unsystematic_risk_last_60_days, direction, weight_raw, fnd6_txws, conviction, weight_strength, alphamix` |
| Common operators | `ts_delta, if_else, group_rank, rank, abs, vec_avg, ts_decay_linear, ts_backfill, ts_zscore, group_neutralize` |
...
| Field overlap | Common fields are `unsystematic_risk_last_60_days, direction, weight_raw, fnd6_txws, conviction, weight_strength, alphamix`. |
| Operator overlap | Common operators are `ts_delta, if_else, group_rank, rank, abs, vec_avg, ts_decay_linear, ts_backfill, ts_zscore, group_neutralize`. |
