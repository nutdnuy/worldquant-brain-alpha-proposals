---
title: "C053 - Options Skew Risk Appetite - Put-Call OI + 60D IV Skew + Dividend Model + News Volatility"
...
# C053 - Options Skew Risk Appetite - Put-Call OI + 60D IV Skew + Dividend Model + News Volatility
...
| Dominant families | risk/credit/volatility (2), analyst/model scores (2), news/sentiment/buzz (2), options/implied volatility (2) |
| Common fields | `implied_volatility_put_60, mdl77_fangma_mam7, direction, pcr_oi_270, implied_volatility_call_60, weight_raw, news_range_stddev, conviction, weight_strength, alphamix` |
| Common operators | `if_else, group_zscore, abs, rank, ts_mean, trade_when, ts_backfill` |
...
| Field overlap | Common fields are `implied_volatility_put_60, mdl77_fangma_mam7, direction, pcr_oi_270, implied_volatility_call_60, weight_raw, news_range_stddev, conviction, weight_strength, alphamix`. |
| Operator overlap | Common operators are `if_else, group_zscore, abs, rank, ts_mean, trade_when, ts_backfill`. |
| Family overlap | Dominant workbook families are risk/credit/volatility (2), analyst/model scores (2), news/sentiment/buzz (2), options/implied volatility (2). |
