---
title: "Capital Productivity Momentum Cluster 046 - cogs c"
...
# Capital Productivity Momentum Cluster 046 - cogs c
...
| Common fields | `cogs, c, cap, fnd6_fopo, cost, op, g` |
| Common operators | `zscore, winsorize, abs, group_neutralize, ts_mean, rank, trade_when` |
...
| Field overlap | Common fields are `cogs, c, cap, fnd6_fopo, cost, op, g`. |
| Operator overlap | Common operators are `zscore, winsorize, abs, group_neutralize, ts_mean, rank, trade_when`. |
