---
title: "C004 - Price Volume Reversal - Price Liquidity"
...
# C004 - Price Volume Reversal - Price Liquidity
...
| Dominant families | price-volume/liquidity/turnover (7), execution cost (2), execution cost; threshold/no-trade region (1), trading volume alpha (1), liquidity/turnover (1), risk/volatility scaling (1), mean-variance/risk scaling (1) |
| Common fields | `ts_av_diff, y, turn, volume, x, sharesout, z, ts_decay_exp_window, vwap, change_day, close, lowrisk` |
| Common operators | `rank, ts_backfill, abs, winsorize, ts_mean, group_rank, trade_when, ts_std_dev, scale` |
...
| Field overlap | Common fields are `ts_av_diff, y, turn, volume, x, sharesout, z, ts_decay_exp_window, vwap, change_day, close, lowrisk`. |
| Operator overlap | Common operators are `rank, ts_backfill, abs, winsorize, ts_mean, group_rank, trade_when, ts_std_dev, scale`. |
| Family overlap | Dominant workbook families are price-volume/liquidity/turnover (7), execution cost (2), execution cost; threshold/no-trade region (1), trading volume alpha (1), liquidity/turnover (1), risk/volatility scaling (1), mean-variance/risk scaling (1). |
