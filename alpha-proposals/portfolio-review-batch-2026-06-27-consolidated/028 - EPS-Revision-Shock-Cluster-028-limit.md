---
title: "EPS Revision Shock Cluster 028 - limit"
...
# EPS Revision Shock Cluster 028 - limit
...
| Dominant families | quality/growth/value (4), options/implied volatility (4), analyst/model scores (4), risk/credit/volatility (4), earnings/EPS/guidance revisions (4) |
...
| Common operators | `signed_power, zscore, scale, winsorize, ts_std_dev, ts_mean, max, group_rank, group_neutralize, ts_backfill, ts_corr, rank` |
...
| Operator overlap | Common operators are `signed_power, zscore, scale, winsorize, ts_std_dev, ts_mean, max, group_rank, group_neutralize, ts_backfill, ts_corr, rank`. |
| Family overlap | Dominant workbook families are quality/growth/value (4), options/implied volatility (4), analyst/model scores (4), risk/credit/volatility (4), earnings/EPS/guidance revisions (4). |
